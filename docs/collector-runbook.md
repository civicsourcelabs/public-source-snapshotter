...
| `Source Snapshot: Navii Detail` | 毎月4日 00:30 JST | `execute=true`、`artifact_mode=encrypted_full`、`candidate_mode=all`、`shard_count=32`、`max_parallel=32`、`max_pages_per_shard=0`、`artifact_retention_days=14` |
